...
const useStyles = makeStyles()((theme, _params, classes) => ({
  ...
  landingWrap: {
    backgroundImage:
      `linear-gradient(${theme.palette.background.paper} 0%, ${theme.palette.mode === 'dark' ? darken(theme.palette.primary.dark, 0.75) : theme.palette.primary.light} 80%);`,
  },
  container: {
  ...
  footer: {
    background: theme.palette.mode === 'dark' ? darken(theme.palette.primary.dark, 0.75) : theme.palette.primary.light,
